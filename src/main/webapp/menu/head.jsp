...
<%
    ...
    String us_rolecod = session.getAttribute("us_rolecod").toString();
    String us_username = session.getAttribute("us_cod").toString();

    String uri = request.getRequestURI();
    String pageName = uri.substring(uri.lastIndexOf("/") + 1);

    String reports = "", consultazione = "", user = "";

    switch (pageName) {
        case "lavorazione.jsp":
            reports = "m-menu__item--active";
            break;
        case "creaUser.jsp":
        case "searchUser.jsp":
        ...
        case "modifica.jsp":
        case "pratiche.jsp":
        case "accettazione.jsp":
        case "eccessi.jsp":
            consultazione = "m-menu__item--active";
            break;
        default:
            break;
    }
                ...
                <div class="m-stack__item m-brand">
                    <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                        <div class="m-stack__item m-stack__item--middle m-brand__logo">
                            <!--Reindirizzamento a pratiche.jsp quando si clicca sul logo findo dell'header (25/02/21)-->
                            <a href="pratiche.jsp" class="m-brand__logo-wrapper">
                ...
                <div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
                    ...
                    <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
                        <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                            ...
                            <li class="m-menu__item <%=consultazione%> m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link">
                                    <span class="m-menu__item-here"></span>
                                    <span class="m-menu__link-text">Consultazione</span>
                                ...
                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                    <ul class="m-menu__subnav">
                                        <li class="m-menu__item " aria-haspopup="true">
                                            <a href="pratiche.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon flaticon-diagram"></i>
                                                <span class="m-menu__link-title"> 
                                                    <span class="m-menu__link-wrap"> 
                                                        <span class="m-menu__link-text">Pratiche</span> 
                                        ...
                                        <li class="m-menu__item " aria-haspopup="true"><a href="accettazione.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon flaticon-business"></i>
                                                <span class="m-menu__link-title">
                                                    <span class="m-menu__link-wrap">
                                                        <span class="m-menu__link-text">Accettazione</span>
                                                        <span class="m-menu__link-badge"><span class="m-badge m-badge--danger">2</span></span>
                                                    </span>
                                                </span>
                                            </a>
                                        </li>
                                        <li class="m-menu__item " aria-haspopup="true"><a href="eccessi.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon flaticon-business"></i>
                                                <span class="m-menu__link-title">
                                                    <span class="m-menu__link-wrap">
                                                        <span class="m-menu__link-text">Eccessi</span>
                                                        <span class="m-menu__link-badge">
                            ...
                            <li class="m-menu__item <%=reports%> m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link">
                                    <span class="m-menu__item-here"></span>
                                ...
                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                    <ul class="m-menu__subnav">
                                        <li class="m-menu__item m-menu__item--active" aria-haspopup="true">
                                            <a href="lavorazione.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon flaticon-diagram"></i>
                                                <span class="m-menu__link-title">
                                                    <span class="m-menu__link-wrap">
                                                        <span class="m-menu__link-text">Report Lavorazione</span>
                                                        <span class="m-menu__link-badge"><span class="m-badge m-badge--success">1</span>
                                                        </span>
                                                    </span>
                                                </span>
                                            </a>
                            ...
                            <li class="m-menu__item <%=user%> m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true">
                                <a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link">
                                    <span class="m-menu__item-here"></span>
                                    <span class="m-menu__link-text">Utenti</span>
                                    <i class="m-menu__hor-arrow la la-angle-down"></i>
                                    <i class="m-menu__ver-arrow la la-angle-right"></i>
                                </a>
                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                    <ul class="m-menu__subnav">
                                        <li class="m-menu__item m-menu__item--active" aria-haspopup="true">
                                            <a href="creaUser.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon fa fa-user-plus"></i>
                                                <span class="m-menu__link-title">
                                                    <span class="m-menu__link-wrap">
                                                        <span class="m-menu__link-text">Crea</span>
                                                        <span class="m-menu__link-badge"><span class="m-badge m-badge--success">1</span>
                                                        </span>
                                                    </span>
                                                </span>
                                        ...
                                        <li class="m-menu__item m-menu__item--active" aria-haspopup="true">
                                            <a href="searchUser.jsp" class="m-menu__link ">
                                                <i class="m-menu__link-icon fa fa-search"></i>
                                                <span class="m-menu__link-title">
                                                    <span class="m-menu__link-wrap">
                                                        <span class="m-menu__link-text">Cerca</span>
